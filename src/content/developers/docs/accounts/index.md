...
- `nonce` – a counter that indicates the number of transactions sent from the account. This ensures transactions are only processed once. If it is a contract account, this number represents the number of contracts created by the account
